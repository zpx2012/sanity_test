...
def client_tcpdump():
    print('client_tcpdump: start '+datetime.datetime.utcnow().strftime('%Y-%m-%d %H:%M:%S'))
    ...
    print('client_tcpdump '+datetime.datetime.utcnow().strftime('%Y-%m-%d %H:%M:%S'))

def server_tcpdump():
    print('server_tcpdump '+datetime.datetime.utcnow().strftime('%Y-%m-%d %H:%M:%S'))
...
def client_curl():
    print('client_curl '+datetime.datetime.utcnow().strftime('%Y-%m-%d %H:%M:%S'))
    time.sleep(20)
