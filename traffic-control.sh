...
function show_usage {
    ...
    echo "  -d|--delay=50   : define the latency in milliseconds (default: 50)"
    echo "  --uspeed=<speed>: define the upload speed (default: 1024kbit)"
    echo "  --dspeed=<speed>: define the download speed (default: 1024kbit)"
